...
public class PaillierKey implements Serializable {
	...
	/* Modified : fxs161530@utdallas.edu 
	 * MAX_KEY_SIZE = 512 to MAX_KEY_SIZE = 4098; Required by Q2(a)
	 * For Q2(c) 8192 Bits is required
	 * */
	
	protected static final int MAX_KEY_SIZE = 8192;
	...
	public PaillierKey(BigInteger n, Random rnd) {
		if (n.bitLength() > MAX_KEY_SIZE) {
			...
			System.out.println("Inside PaillierKey.java ln:113");
			System.out.println("Exceeded MaX_Key_Size : " + n.bitLength());
